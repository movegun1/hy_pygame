...
def create_title(text, x, y, text_color):
    font = pygame.font.Font(FONT_FILE, 20)
...
def main():
    ...
    title_surface, title_rect = create_title(title_text, SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2, (0, 0, 0))  # Change text color to red

    # 메뉴 화면
    button_x = SCREEN_WIDTH // 2
    button_y = SCREEN_HEIGHT // 7
